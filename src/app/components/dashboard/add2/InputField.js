...
const InputField = ({ field, updateCentral, updateValidation, item }) => {
  const handleChange = (e) => {
    updateCentral(item, { [field.DB_COLUMN]: e.target.value });
    updateValidation(item, true); // Add validation logic here
  };
